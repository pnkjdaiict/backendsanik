...
class CoursesAdmin(admin.ModelAdmin):
    form = CourseForm
    fields = (
          'title','short_description','slug_field' ,'description', 'image','image_preview' , 'image_alt', 'course_code', 'states' ,'cities', 'localities' ,'meta_keyword' ,  'meta_title' , 'meta_description','contact_number','facebook_link','instagram_link','youtube_link', )
...
class SubCoursesAdmin(admin.ModelAdmin):
    form = SubCourseForm
    fields = (
        'title', 'slug_field', 'short_description', 'description', 'image','image_preview' , 'image_alt', 'course_code', 'price', 'courses' , 'meta_keyword',  'meta_title' , 'meta_description',
            'contact_number',
            'facebook_link' ,
            'instagram_link',
            'youtube_link'  ,
